...
export default {
  ...
  FETCH_MESSAGES_REQUEST: getType('FETCH_MESSAGES_REQUEST'),
  FETCH_MESSAGES_SUCCESS: getType('FETCH_MESSAGES_SUCCESS'),
  FETCH_MESSAGES_FAILURE: getType('FETCH_MESSAGES_FAILURE'),

  SET_ACTIVE_CHAT: getType('SET_ACTIVE_CHAT'),
  UNSET_ACTIVE_CHAT: getType('UNSET_ACTIVE_CHAT'),
};
